...
internal class CustomizableDialogServiceTests
{
    ...
    public void RunOperation_With_CancellationToken_WithOverride_Should_Call_Override_Service()
    {
        ...
        // Assert
        mockOverride.Verify(x => x.RunOperation("Test title", It.IsAny<Func<CancellationToken, IProgress<ProgressReport>, Task>>()),
            Times.Once);
    }
    ...
    public void RunOperation_With_CancellationToken_And_Function_WithOverride_Should_Call_Override_Service()
    {
        ...
        // Assert
        mockOverride.Verify(x => x.RunOperation<string>("Test title", It.IsAny<Func<CancellationToken, IProgress<ProgressReport>, Task<string>>>()),
            Times.Once);
    }
