...
internal class DialogServiceTests
{
    ...
    public async Task RunOperation_Action_With_Valid_Operation_Runs_Successfully()
    {
        ...
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.RunOperation(operation)));
    }
    ...
    public async Task RunOperation_String_Action_With_Valid_Operation_Runs_Successfully()
    {
        ...
        var operation = new Action<IProgress<ProgressReport>>(p => { });
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.RunOperation(title, operation)));
    }
    ...
    {
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.AskYn("Test question")));
    }
    ...
    {
        var title = "Test Title";
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.AskYn(title, "Test question")));
    }

    [Test]
    public async Task AskYnc_With_Valid_Question_Returns_Boolean()
    {
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.AskYnc("Test question")));
    }
    ...
    {
        var title = "Test Title";
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.AskYnc(title, "Test question")));
    }
    ...
    public async Task Show_DialogTemplate_With_Valid_Template_Returns_Result()
    {
        ...
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.Show(template)));
    }

    [Test]
    public async Task Message_With_Valid_Message_Returns_Result()
    {
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.Message("Test message")));
    }
    ...
    {
        var title = "Test Title";
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.Message(title, "Test message")));
    }

    [Test]
    public async Task Warning_With_Valid_Message_Returns_Result()
    {
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.Warning("Test message")));
    }
    ...
    {
        var title = "Test Title";
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.Warning(title, "Test message")));
    }

    [Test]
    public async Task Error_With_Valid_Message_Returns_Result()
    {
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.Error("Test message")));
    }
    ...
    public async Task Error_Exception_With_Valid_Exception_Returns_Result()
    {
        ...
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.Error(exception)));
    }
    ...
    {
        var title = "Test Title";
        Assert.DoesNotThrowAsync((Func<Task>)(() => _mockService.Object.Error(title, "Test message")));
    }
}
