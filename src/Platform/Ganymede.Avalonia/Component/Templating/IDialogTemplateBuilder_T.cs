...
public interface IDialogTemplateBuilder<in T> : IDialogTemplateBuilder where T : DialogViewModelBase
{
    ...
    /// </param>
    /// <returns>
    /// A <see cref="Control"/> that allows for interactivity with the
    ...
    /// </param>
    /// <returns>
    /// A <see cref="Control"/> that defines the dialog UI for the specified
    /// <see cref="IDialogViewModel"/>, or <see langword="null"/> if no UI was
    /// generated.
    /// </returns>
