...
public class TitleBarControl : ContentControl
{
    ...
    static TitleBarControl()
    {
        ...
        (HideWindowCommandPropertyKey, HideWindowCommandProperty) = NewDpReadOnly<ICommand>(nameof(HideWindowCommand));
        (ShowWindowCommandPropertyKey, ShowWindowCommandProperty) = NewDpReadOnly<ICommand>(nameof(ShowWindowCommand));
        (CloseWindowCommandPropertyKey, CloseWindowCommandProperty) = NewDpReadOnly<ICommand>(nameof(CloseWindowCommand));
    ...
    private static (DependencyPropertyKey, DependencyProperty) NewDpReadOnly<T>(string name, T defaultValue = default!)
    {
        var dpr = DependencyProperty.RegisterReadOnly(name, typeof(T), typeof(TitleBarControl), new PropertyMetadata(defaultValue));
        var dp = dpr.DependencyProperty;
        return (dpr, dp);
    }
